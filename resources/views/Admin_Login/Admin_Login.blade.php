    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl shadow-2xl p-8 space-y-6">
            ...
            <div class="text-center">
                <h1 class="text-3xl font-semibold text-blue-900 mb-2">Login Form</h1>
                <p class="text-gray-600">wellcome to your special space</p>
            </div>

            <!-- Laravel Form -->
            <form method="POST" action="{{ route('Login_Admin') }}" class="space-y-6">
                @csrf
